        ...
        <div className="container mx-auto px-4 py-10 md:py-14">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <a
              ...
              aria-label="Contattaci su WhatsApp per un preventivo gratuito"
              className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1fb455] text-white font-bold px-6 py-4 rounded-2xl transition-all hover:-translate-y-0.5 shadow-[0_10px_30px_-10px_rgba(37,211,102,0.5)] whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-foreground"
            >
