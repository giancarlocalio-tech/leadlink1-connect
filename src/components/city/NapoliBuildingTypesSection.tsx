/**
 * NapoliBuildingTypesSection - Building types and their challenges
 * 
 * Shows expertise on Naples-specific building types
 */

import { Home, Building2, Castle, Factory } from 'lucide-react';
import { NAPOLI_BUILDING_TYPES } from '@/lib/napoliSeoContent';

const buildingIcons = [Castle, Building2, Home, Factory];

export function NapoliBuildingTypesSection() {
  return (
    <section className="py-16 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            Tipi di Edifici a Napoli e Problemi Idraulici Specifici
          </h2>
          
          <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
            Ogni tipologia edilizia napoletana presenta sfide idrauliche specifiche. 
          ...
          <div className="space-y-6">
            {NAPOLI_BUILDING_TYPES.map((building, index) => {
