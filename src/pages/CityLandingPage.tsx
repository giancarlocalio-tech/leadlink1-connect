        ...
        <div className="container mx-auto px-4 relative z-10 py-10 md:py-20">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-primary/10 text-primary border border-primary/20 px-3.5 py-1.5 rounded-full text-xs md:text-sm font-semibold mb-6">
                <MapPin className="h-3.5 w-3.5" />
                <span>{cityData.name}, {cityData.region}</span>
              </div>
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0">
                Trova subito un idraulico professionista a {cityData.name} e provincia. Preventivo gratis, nessun obbligo, solo verificati.
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-2 text-sm text-muted-foreground">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-medium text-foreground">100% Gratuito</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Clock className="h-4 w-4 text-success" />
                  <span>Risposta in 15 min</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
                  <span><span className="font-bold text-foreground">{rating.ratingValue}/5</span> recensioni</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-md lg:max-w-none">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl ring-1 ring-foreground/5 aspect-[4/5]">
                  <img
                    src={heroPlumber}
                    alt={`Idraulico professionista a ${cityData.name}`}
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <p className="text-xs uppercase tracking-wider opacity-80">Verificato a {cityData.name}</p>
                    <p className="text-base font-semibold">Idraulici professionisti · Pronto intervento</p>
                  </div>
                </div>

                <div className="hidden sm:flex absolute -right-3 lg:-right-6 bottom-12 bg-background rounded-2xl shadow-xl border border-border px-4 py-3 items-center gap-3">
                  <div className="relative flex h-2.5 w-2.5">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-success opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-success"></span>
                  </div>
                  <div className="text-left">
                    <p className="text-xs text-muted-foreground">Disponibili ORA</p>
                    <p className="text-sm font-bold text-foreground">{cityData.name}</p>
                  </div>
                </div>
              </div>
            </div>
