...
-- Fix unlock_contact_with_credits to use case-insensitive city matching
-- Same pattern as get_trial_available_requests
...
BEGIN
  ...
  -- Check service area using case-insensitive matching (same as get_trial_available_requests)
  SELECT EXISTS (
...
-- Also fix trial_claim_request to use the same case-insensitive matching
